...
const it = {
  ...
  'home.start.title': 'Il tuo primo percorso di programmazione',
  'home.start.lead': 'Non hai mai scritto codice? Parti dal primo passo: ogni tappa introduce le basi necessarie per la successiva.',
  'home.start.step': 'Passo {number}',
  'home.start.step1': 'Primi concetti',
  'home.start.step2': 'Come funzionano i linguaggi',
  'home.start.step3': 'Poi scegli un linguaggio',
...
const en = {
  ...
  'home.start.pill': 'START HERE',
  'home.start.title': 'Your first programming path',
  'home.start.lead': 'Never written code before? Start with step one: each stop introduces the basics needed for the next.',
  'home.start.step': 'Step {number}',
  'home.start.step1': 'First concepts',
  'home.start.step2': 'How languages work',
  'home.start.step3': 'Choose a language next',
  'home.explore.pill': 'EXPLORE',
